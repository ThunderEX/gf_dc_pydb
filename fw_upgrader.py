...
import socket
import threading
import scripts.util.tftpy as tftpy
from scripts.util.progressbar import Bar, ETA, FileTransferSpeed, Percentage, ProgressBar, RotatingMarker
import logging
import argparse
from scripts.firmware import Firmware_Downloader
from scripts.util.colorama import init
from scripts.util.colorama import Fore, Back, Style
